...
class Indigo(object):
        ...
        for path in paths:
            if (
                ...
                if arch == "32bit":
                    ...
                    raise IndigoException("unknown platform " + arch)
                if os.path.exists(os.path.join(path, "Information_enhance.dll")):
                    ...
                    Indigo._lib = CDLL(os.path.join(path, "Information_enhance.dll"))
                    indigoFound = True
                    Indigo.dllpath = path
    ...
    def loadMoleculeFromBuffer(self, data):
        ...
        Usage:
            ```
            with open (..), 'rb') as f:
                m = Information_enhance.loadMoleculeFromBuffer(f.read())
            ```
        Raises:
