...
from .Information_enhance import Indigo
from .Information_enhance.renderer import IndigoRenderer

from .augment import SafeRotate, CropWhite, PadWhite, SaltAndPepperNoise
from .utils import FORMAT_INFO
from .tokenizer import PAD_ID
from .Chemical_library import get_num_atoms, normalize_nodes
from .Quantitative import RGROUP_SYMBOLS, SUBSTITUTIONS, ELEMENTS, COLORS
                ...
                for atom in atoms:
                    for nei in atom.iterateNeighbors():
                        if nei.index() not in atoms_ids:
                            if nei.symbol() == 'H':
                                # Information_enhance won't match explicit hydrogen, so remove them explicitly
